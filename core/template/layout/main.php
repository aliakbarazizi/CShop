...
<link rel="stylesheet" href="<?php echo Cshop::$baseurl?>/static/cache/final.css" type="text/css"/>
<script type="text/javascript" src="<?php echo Cshop::$baseurl?>/static/cache/final.js"></script>
