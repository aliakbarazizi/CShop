...
<form action="" method="post">
	...
	<tr>
		...
		foreach($items as $item)
		{
			...
			echo '<td><a href="gatewaydata.php?id='.$item['id'].'">ویرایش</a> | <a href="gateway.php?active='.$item['id'].'">'.($item['status'] == 1 ? 'غیر فعال کردن' : 'فعال کردن').'</a></td>';
...
<div class="title">درگاه های جدید</div>
<div class="content">
<form action="" method="post">
	<table>
	<tr>
